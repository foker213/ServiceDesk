export default {
    common: {
        ...
        shrink: 'Put away',
        expand: 'Expand',
        delMessage: 'Удалить выбранные записи?',
        delWarning: 'Внимание',
        delOk: 'OK',
        delCancel: 'Отменить',
        delNoData: 'Please select the data to delete',
        delSuccess: 'Выбранные записи удалены',
        refresh: 'Refresh',
        полныйscreen: 'Fullscreen',
        size: 'Size',
    ...
    rule: {
        ...
        passwordMinLength: 'Пароль должен содержать не менее 8 знаков'
    },
    lock: {
    ...
    error: {
        ...
        valueNotNumber: 'Значения должны быть числами и разделены ;'
    },
    setting: {
