        ...
        children: [
            {
                name: 'MyApplications',
                path: 'myapplications',
                component: 'views/Catalog/MyApplications/MyApplications',
                meta: {
                    title: 'router.myApplications',
                    noCache: true,
                }
            },
            {
                ...
                component: 'views/Catalog/UndistributedApplications/UndistributedApplications',
                meta: {
                    title: 'router.undistributedApplications',
                    noCache: true,
                }
            },
            {
